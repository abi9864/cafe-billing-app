...
VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Raja\'s Cafe - Main', '12 Coffee Lane, CBD', 'Mumbai', 'Maharashtra', '400001', '+91-22-12345678', 'main@rajascafe.com'),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'Raja\'s Cafe - Andheri', '45 Cafe Street, Andheri West', 'Mumbai', 'Maharashtra', '400058', '+91-22-87654321', 'andheri@rajascafe.com');
...
VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'receipt_footer', 'Thank you for visiting Raja\'s Cafe! Come back soon.', 'string'),
  ...
  (NULL, 'app_name', 'Raja\'s Cafe POS', 'string'),
