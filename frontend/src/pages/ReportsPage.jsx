...
const COLORS = ['#d4862a', '#6b3d2e', '#2c1810', '#e8c99a', '#f5e6d3'];
          ...
          <div className="card p-5">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={salesReport?.data || []}>
                ...
                <Bar dataKey="total_revenue" fill="#d4862a" radius={[4, 4, 0, 0]} name="Revenue" />
              </BarChart>
            </ResponsiveContainer>
          </div>
              ...
              {topItems.length > 0 ? (
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={topItems} layout="vertical">
                    ...
                    <Tooltip />
                    <Bar dataKey="total_quantity" fill="#6b3d2e" radius={[0, 4, 4, 0]} name="Qty Sold" />
                  </BarChart>
                </ResponsiveContainer>
              ...
              {paymentTrends.length > 0 ? (
                <div className="flex items-center gap-4">
                  <PieChart width={180} height={180}>
                    ...
                    <Tooltip formatter={(v, n, p) => [v, p.payload.payment_method]} />
                  </PieChart>
                  <div className="space-y-2">
                    {paymentTrends.map((pt, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm">
                        <div className="w-3 h-3 rounded-full" style={{ background: COLORS[i % COLORS.length] }} />
                        <span className="capitalize text-gray-700">{pt.payment_method || 'Unknown'}</span>
