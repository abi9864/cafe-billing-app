...
export const menuService = {
  ...
  getRecipe: (itemId) => api.get(`/menu/items/${itemId}/recipe`),
  addRecipeItem: (itemId, data) => api.post(`/menu/items/${itemId}/recipe`, data),
  removeRecipeItem: (itemId, recipeItemId) => api.delete(`/menu/items/${itemId}/recipe/${recipeItemId}`)
};
...
export const razorpayService = {
  createOrder: (orderId) => api.post('/razorpay/create-order', { order_id: orderId }),
